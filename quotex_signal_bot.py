...
async def capture_chart(pair: str, output_path: str):
    async with async_playwright() as p:
        ...
        # 1-Minute Timeframe, Pure Black Background, Glowing Neon Candles & Zoomed View
        ...
        for attempt in range(3):
            try:
                ...
                await asyncio.sleep(6)  # Fully render bright candles
...
async def main():
    print("Fatima Forex FX Bot Active (1m Chart & Clear Dark Glowing Theme)...")
